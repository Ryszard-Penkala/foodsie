            ...
            <>
                <AppContext.Provider value={ this.state.imageLink }>
                    <section className={ styles.wrapper }>
                        ...
                        />
                        <label for={types.Popular} className = { styles.radioButtonLabel }>Popular</label>
                        <input
                            className = { styles.radioButton }
                            id = {types.Sugessted}
                            type = 'radio'
                        ...
                        />
                        <label for={types.Sugessted} className = { styles.radioButtonLabel }>Sugessted</label>
                        <input
                            className = { styles.radioButton }
                            id = {types.Extreme}
                            type = 'radio'
                        ...
                        />
                        <label for={types.Extreme} className = { styles.radioButtonLabel }>Extreme</label>
